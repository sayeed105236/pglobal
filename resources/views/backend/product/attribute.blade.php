        ...
        <div class="row">
            ...
            <div class="col-md-5 col-sm-12 col-12 fit_inblc">
                <div class="card widget-box">
                    ...
                    <form autocomplete="off" action="{{URL('makecommand/insert_attribute')}}" method="post" enctype='multipart/form-data'>
                            {{csrf_field()}}
                    ...
                    <div class="card-body table-responsive">
                        ...
                        <table id="zero_config" class="table table-bordered data-table" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                <form autocomplete="off" action="{{URL('makecommand/update_attribute')}}" method="post" enctype='multipart/form-data'>
                                {{csrf_field()}}
                                ...
                                <input type="hidden" name="product_id" value="{{$data->product_id}}">
                                    ...
                                    <td>
                                       ...
                                       <a class="btn btn-danger" href="{{URL('makecommand/delete_attribute?id=')}}{{$data->id}}">
                                           Delete
                                       </a>
                                    </td>
                                </form>
