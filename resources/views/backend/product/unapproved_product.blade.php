...
@section('title','Unapproved Product')
            ...
            <div class="col-12">
                <div class="card widget-box">
                    <div class="card-header  widget-title">
                        <h5 class="card-title">Unapproved Product Datatable</h5>
                    </div>
                    <div class="card-body">
                            <div class="col-md-5 col-12 left plussrc">
                                <a href="{{URL('makecommand/unapproved_product')}}" class="btn btn-primary"><i class="fas fa-sync-alt"></i> Refresh</a>
                            </div>

                            <form method="get" action="{{URL('makecommand/unapproved_product')}}">
                            ...
                            <table id="zero_config" class="table table-bordered table-striped text-center dataTable" width="100%" cellspacing="0">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th><b>Image</b></th>
                                        <th class="sort_th">
                                            <form method="get" action="{{URL('makecommand/sort_unapproved_product')}}" class="sort_form">
                                ...
                                <tr>
                                    ...
                                    <th>-------</th>
                                    <th>
                                        <form method="get" action="{{URL('makecommand/search_unapproved_product')}}" class="sort_form">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="txt_c">
                                            <a href="{{URL('makecommand/attribute?id=')}}{{$data->id}}" class="cs_attribute">
                                                Attribute
                                            </a>
                                        </td>
                                        <td class="txt_c">
                                        ...
                                        <td>
                                            <a href="{{URL('makecommand/edit_product?id')}}={{$data->id}}" class="btn btn-primary">Edit</a>
                                              ...
                                              <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                  ...
                                                  <div class="modal-footer">
                                                    ...
                                                    <a href="{{URL('makecommand/delete_product?id')}}={{$data->id}}" type="button" class="btn btn-danger">Delete</a>
                                                  </div>
                                                </div>
                                              </div>
                                            </div>
