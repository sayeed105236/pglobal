                ...
                <div class="card widget-box">
                    ...
                    <div class="card-body">
                            <div class="col-md-5 col-12 left plussrc">
                                <a href="{{URL('makecommand/add_product')}}" class="btn btn-warning">
                                    Add a new product +
                                </a>
                            </div>
                            <div class="col-md-5 col-12 left plussrc">
                                <a href="{{URL('makecommand/product')}}" class="btn btn-primary"><i class="fas fa-sync-alt"></i> Refresh</a>
                            </div>

                            <form method="get" action="{{URL('makecommand/product')}}">
                            ...
                            <table id="zero_config" class="table table-bordered table-striped text-center dataTable" width="100%" cellspacing="0">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th><b>Image</b></th>
                                        <th class="sort_th">
                                            <form method="get" action="{{URL('makecommand/sort_product')}}" class="sort_form">
                                ...
                                <tr>
                                    ...
                                    <th>-------</th>
                                    <th>
                                        <form method="get" action="{{URL('makecommand/search_product')}}" class="sort_form">
