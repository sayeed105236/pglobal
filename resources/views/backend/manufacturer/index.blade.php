                ...
                <div class="card widget-box">
                    ...
                    <div class="card-body">
                            <div class="col-md-5 col-12 left plussrc">
                                <a href="{{URL('makecommand/add_manufacturer')}}" class="btn btn-warning">
                                    Add a new manufacturer +
                                </a>
                            </div>

                            <form method="get" action="{{URL('makecommand/manufacturer')}}">
...
<br><br>
                        ...
                        <div class="table-responsive">
                            <table id="zero_config" class="table table-bordered data-table" width="100%" cellspacing="0">
                                {{$manufacturer_tbl->links()}}
                                <thead>
                                    <tr>
<!-- Sorting -->
<th class="sort_th">
    <form method="get" action="{{URL('makecommand/sort_manufacturer')}}" class="sort_form">
...
<th>
    <form method="get" action="{{URL('makecommand/search_manufacturer')}}" class="sort_form">
    ...
    <form method="get" action="{{URL('makecommand/search_manufacturer')}}" class="sort_form">
        ...
        <select name="search" class="small_src_in" id="selectredirectservice" onchange="redirectservice()">
            ...
            @foreach($d_parent_id as $d_parent_id)
                    ...
                    @php
                        $parent_name=App\admin\manufacturer_tbl::all()->where("id",$parent_id);
                    @endphp
...
<th>-------</th>
                                ...
                                <tbody>
                                    @foreach($manufacturer_tbl as $data)
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <a href="{{URL('makecommand/edit_manufacturer?id')}}={{$data->id}}" class="editBtn edbtn">Edit</a>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        Do you really want to delete {{$loop->iteration}}no manufacturer???
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        <a href="{{URL('makecommand/delete_manufacturer?id')}}={{$data->id}}" type="button" class="btn btn-danger">Delete</a>
      </div>
    </div>
  </div>
</div>
