        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="card widget-box">
                    ...
                    <div class="card-body">
                    <form autocomplete="off" action="{{URL('makecommand/update_page')}}" method="post" enctype='multipart/form-data'>
                      {{csrf_field()}}
                      <input type="hidden" name="id" value="{{$id->id}}">
                        <div class="control-group col-md-12 col-12">
                            ...
                            <div class="controls col-md-9 col-12">
                                <input type="text" name="name" value="{{$id->name}}" id="name" class="" required>
                            </div>
                        </div>
                        <div class="control-group col-md-12 col-12">
                            <label class="control-label col-md-3 col-12">
