            ...
            <div class="col-12">
                <div class="card widget-box">
                    <div class="card-header  widget-title">
                        <h5 class="card-title">Pending Users Datatable</h5>
                    </div>
                    <div class="card-body">
                            ...
                            <form autocomplete="off" method="get" action="{{URL('makecommand/pending_user')}}">
...
<!-- Sorting -->
<th class="sort_th">
    <form autocomplete="off" method="get" action="{{URL('makecommand/sort_pending_user')}}" class="sort_form">
...
<th class="sort_th">
    <form autocomplete="off" method="get" action="{{URL('makecommand/sort_pending_user')}}" class="sort_form">
        ...
        <input type="hidden" name="orderby" value="request_role">
        <input type="hidden" name="ordertype" value="ASC">
        <button class="sort_btn" type="submit">
                        <i class="fas fa-sort-amount-up-alt"></i>
        </button>
...
<th>
    <form autocomplete="off" method="get" action="{{URL('makecommand/search_pending_user')}}" class="sort_form">
...
<th>
    <form autocomplete="off" method="get" action="{{URL('makecommand/search_pending_user')}}" class="sort_form">
        ...
        <input type="hidden" name="dto" value="{{$dto}}">
        @endif
        <input type="hidden" name="search_by"  id="selectredirectserviceby" value="request_role">
...
<th>
    <a href="{{URL('makecommand/search_pending_user?search_by=status&search=1')}}" class="enable">Active</a>
    <a href="{{URL('makecommand/search_pending_user?search_by=status&search=0')}}" class="disable">Deactive</a>
</th>
<th>
...
<th>-------</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$data->name}}</td>
                                        <td>
                                            @if($data->request_role == "admin")
                                                <option value="admin">Admin</option>
                                            @elseif($data->request_role == "affiliate")
                                                <option value="affiliate">Affiliate</option>
                                            @elseif($data->request_role == "vendor")
                                                <option value="vendor">Vendor</option>
                                            @elseif($data->request_role == "dealer")
                                                <option value="dealer">Dealer</option>
                                            @elseif($data->request_role == "user")
                                                <option value="user">User</option>
                                            @else
                                                <option>{{$data->request_role}}</option>
                                            @endif
                                        </td>
                                        <td>
...
@section('script')
    ...
    @if( !empty($dfrom) or  !empty($dto))               
        ...
        function redirectservice() {
          ...
          var url="{{URL('makecommand/search_pending_user')}}";
