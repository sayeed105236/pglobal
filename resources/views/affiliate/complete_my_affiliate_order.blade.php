...
@section('title','My Completed affiliate Orders')
@section('body')
                ...
                <div class="ml-auto text-left">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">My Completed affiliate Orders</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="col-12">
                <div class="card widget-box">
                    <div class="card-header  widget-title">
                        <h5 class="card-title">Reffered Completed Product Order datatable</h5>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8 col-12 text-center">
                                <a href="{{URL('affiliate-dashboard/complete_my_affiliate_order')}}" class="btn btn-primary">
...
<br>
                        <div class="row">
                            ...
                            <div class="col-md-8 col-12 alert alert-info text-center" role="alert">
                                Total complete orders of mine <b>{{$complete_my_affiliate_order_count}}</b>
                            </div>
                            <div class="col-md-2 col-12"></div>
                        </div>
...
<br><br><br>
                        <div class="">
                            <form method="get" action="{{URL('affiliate-dashboard/complete_my_affiliate_complete_my_affiliate_order')}}" class="">
...
<br><br>
                        ...
                        <div class="table-responsive">
                            <table id="zero_config" class="table table-bordered data-table" width="100%" cellspacing="0">
                                {{$complete_my_affiliate_order->links()}}
                                <thead>
                                    <tr>
                                        <!-- Sorting -->
                                        <th class="sort_th">
                                            <form method="get" autocomplete="off" action="{{URL('affiliate-dashboard/sort_complete_my_affiliate_order')}}" class="sort_form">
                                ...
                                <!-- <tr>
                                    ...
                                    <th>
                                        <form method="get" autocomplete="off" action="{{URL('affiliate-dashboard/search_complete_my_affiliate_order')}}" class="sort_form">
                                ...
                                <tbody>
                                    @foreach($complete_my_affiliate_order as $data)
                                    <tr>
                            ...
                            </table>{{$complete_my_affiliate_order->links()}}
                        </div>
    ...
    @if( !empty($dfrom) or  !empty($dto))               
        ...
        function redirectservice() {
          ...
          var url="{{URL('affiliate-dashboard/search_complete_my_affiliate_complete_my_affiliate_order')}}";
