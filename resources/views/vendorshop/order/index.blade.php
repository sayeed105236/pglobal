                            ...
                            <div class="col-md-12 row">
                                ...
                                <div class="col-md-7">
                                    <div class="col-md-12 col-12 left plussrc">
                                        <a href="{{URL('vendor-dashboard/order')}}" class="btn btn-primary"><i class="fas fa-sync-alt"></i> Refresh</a>
                                    </div>
                                    <form method="get" autocomplete="off" action="{{URL('vendor-dashboard/order')}}">
                            ...
                            <table id="zero_config" class="table table-bordered data-table" width="100%" cellspacing="0">
                                ...
                                <thead>
                                    <tr>
                                        <!-- Sorting -->
                                        <th class="sort_th">
                                            <form method="get" autocomplete="off" action="{{URL('vendor-dashboard/sort_order')}}" class="sort_form">
                                ...
                                <tr>
                                    ...
                                    <th>
                                        <form method="get" autocomplete="off" action="{{URL('vendor-dashboard/search_order')}}" class="sort_form">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{URL('vendor-dashboard/edit_order?id')}}={{$data->id}}">{{$data->order_code}}</a>
                                        </td>
                                        <td>
                                            <a href="{{URL('vendor-dashboard/edit_order?id')}}={{$data->id}}">{{$data->name}}
                                            </a>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <a href="{{URL('vendor-dashboard/show_order?id')}}={{$data->id}}" class="btn btn-warning">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <a href="{{URL('vendor-dashboard/edit_order?id')}}={{$data->id}}" class="btn btn-primary">Edit</a>
                                        </td>
                                    </tr>
                                    @endforeach
...
@section('script')
    ...
    @if( !empty($dfrom) or  !empty($dto))               
        ...
        function redirectservice() {
          ...
          var url="{{URL('vendor-dashboard/search_order')}}";
